...
import ReportDeviations from "../components/ReportDeviations";
      ...
      {loading ? (
        ...
        <>
          ...
          <ReportDeviations
            ...
            devTotLimit={devTotLimit}
            devTotSpent={devTotSpent}
            devTotDev={devTotDev}
            devTotOver={devTotOver}
            alertThreshold={alertThreshold}
            projectDevRows={projectDevRows}
            activeProject={activeProject}
            deviationPeriodLabel={deviationPeriodLabel}
          />
        </>
      )}
    </div>
