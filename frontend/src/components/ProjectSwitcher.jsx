      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-w-md">
          ...
          <p className="text-sm text-[#5C626A] -mt-1">
            Cada proyecto tiene sus propios gastos, presupuesto, categorías y estadísticas.
          </p>
                ...
                {projects.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span className="block text-sm font-medium text-[#1A1D20] truncate">{p}</span>
                        {meta.description && (
                          <span className="block text-xs text-[#5C626A] truncate">{meta.description}</span>
                        )}
                      </button>
                      {activeProject === p && (
                        <span className="text-xs text-[#D95D39] inline-flex items-center gap-1 shrink-0">
          ...
          {/* Ficha del proyecto */}
          {editing && (
            <div className="mt-4 rounded-xl border border-[#E2DDD3] bg-[#FAF8F5] p-3 space-y-3">
                    ...
                    return (
                      <button
                        ...
                        className={`w-8 h-8 rounded-lg border flex items-center justify-center ${
                          active ? "bg-[#1E293B] text-white border-[#1E293B]" : "bg-white text-[#1A1D20] border-[#E2DDD3]"
                        }`}
                        title={n}
                      >
